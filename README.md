...
You can write validators, generators, or checkers using KompGen. You do this by following [this tutorial](docs/TUTORIAL.md) (beginner-friendly) and/or [this tutorial](docs/PREPARATION.md). There, it is explained how to write them in the context of preparing the *whole* problem via KompGen, but you can also write these scripts independently.

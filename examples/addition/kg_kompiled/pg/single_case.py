from sys import *
BLACK_MAGIC_10892165_6, __name__ = __name__, "BLACK_MAGIC_10892165_6"
from io import StringIO
from random import Random

BLACK_MAGIC_147837782_7, __name__ = __name__, "BLACK_MAGIC_147837782_7"
...
__name__ = BLACK_MAGIC_147837782_7
del BLACK_MAGIC_147837782_7
...
__name__ = BLACK_MAGIC_10892165_6
del BLACK_MAGIC_10892165_6
BLACK_MAGIC_456425871_8, __name__ = __name__, "BLACK_MAGIC_456425871_8"
def print_to_file(file, cases):
    print(len(cases), file=file)
    for arr in cases:
        print(len(arr), file=file)
        print(*arr, sep=' ', file=file)
__name__ = BLACK_MAGIC_456425871_8
del BLACK_MAGIC_456425871_8
